...
{
    public class CaterpillarLevel2Validator : OrderValidatorBase
    {
        private readonly ResourceExtractionProcessor _resourceExtractionProcessor;
        
        public CaterpillarLevel2Validator (UnitBase unit, float interactionRange,  ResourceExtractionProcessor resourceExtractionProcessor)
